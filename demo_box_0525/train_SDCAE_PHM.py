        ...
        for i, data in enumerate(train_loader_no_shuffle, 1):
            ...
            if i % args.plot_freq == 0:
                ...
                if i == 240:
                    ...
                    pic = pic[:,:32].ravel()
                    n = len(orig)
                    plt.plot(range(20,n),orig[20:], label = 'origin', c = 'blue')
                    plt.plot(range(20,n),pic[20:], label = 'reconstruction', c = 'red')
